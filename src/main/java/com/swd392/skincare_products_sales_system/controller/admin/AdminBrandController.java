...
//    @Operation(summary = "Create a brand (ADMIN, MANAGER)", description = "API delete product by its id")
//    public ApiResponse<BrandResponse> createProduct(@RequestBody @Valid BrandCreationRequest request,
